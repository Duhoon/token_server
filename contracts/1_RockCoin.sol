...
contract RockCoin is ERC20Interface {
    ...
    function approve(address spender, uint amount) external virtual override returns (bool){
        ...
        _approve(msg.sender, spender, currentAllowances, amount);
        return true;
    }
    ...
    function _approve(address owner, address spender, uint256 currentAmount, uint amount) internal virtual{
